                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="{{ route('view',$view->slug) }}" title="">
                                                <img width="600" height="270" src="{{ asset('/pic/' . $view->featuredimage) }}" alt="{{ $view->featuredimage }}">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="{{ route('view',$view->slug) }}" title="">{{$view->title}}</a></h4>
                                        <p>{{ Str::limit(strip_tags($view->body), 200, '') }}</p>
                                        <small class="firstsmall"><a class="bg-orange" >{{$view->category}}</a></small>
                                        <small><a >{{$view->created_at->format('d M Y')}}</a></small>
